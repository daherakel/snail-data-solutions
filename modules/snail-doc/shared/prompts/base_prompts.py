...
class BasePrompts:
    ...
    def __init__(self, personality: str = "warm", language: str = "es", custom_instructions: str = ""):
        """
        ...
        """
        self.personality = personality if personality in self.PERSONALITY_VARIANTS else "warm"
        self.language = language
        self.custom_instructions = custom_instructions
        
        self.personality_config = self.PERSONALITY_VARIANTS.get(self.personality, self.PERSONALITY_VARIANTS["warm"])
