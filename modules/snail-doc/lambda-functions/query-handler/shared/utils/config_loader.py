...
class ConfigLoader:
    ...
    def get_integration_env_settings(
        self, integration_name: str, environment: Optional[str] = None
    ) -> Dict[str, Any]:
        """
        ...
        env_settings = self._integration_config.get("environment_settings", {}).get(
            environment, {}
        )
        return env_settings.get(integration_name, {}).copy()

    def is_integration_enabled(
        self, integration_name: str, tenant_id: Optional[str] = None
    ) -> bool:
        """
    ...
    def is_use_case_enabled(
        self, use_case: str, tenant_id: Optional[str] = None
    ) -> bool:
        """
